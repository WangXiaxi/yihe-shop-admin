  ...
  <div class="grid-table">
    <div class="grid-body" flex="dir:top">
      ...
      <div class="button-operation admin-mt-10">
        ...
        <download-excel
        v-if="permission('SeleMallOrder_export')"
...
export default {
  ...
  methods: {
    ...
    handleDetail(row) {
      this.$router.push(`/sele-mall/order-list/page/detail/${row.id}`)
    },
    handleEdit(row) {
      this.$router.push(`/sele-mall/order-list/page/edit/${row.id}`)
    },
    handleSend() {},
    ...
    handleAdd() {
      this.$router.push('/sele-mall/order-list/page/add')
    },
    handleReset() {
