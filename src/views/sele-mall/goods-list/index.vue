  ...
  <div class="grid-table">
    <div class="grid-body" flex="dir:top">
      ...
      <div class="button-operation admin-mt-10">
        <el-button
          v-if="permission('SeleMallGoods_add')"
        ...
        >添加商品</el-button>
        <el-button
          v-if="permission('SeleMallGoods_del')"
          :disabled="disabled"
          :loading="btnLoading"
          type="primary"
          plain
        ...
        >批量删除</el-button>
        <el-button
          v-if="permission('SeleMallGoods_status')"
        ...
        >
          ...
          >
            <template slot-scope="{ row }">
              ...
              <div v-else-if="item.name === 'sort' && permission('SeleMallGoods_sort')">
          ...
          <el-table-column
            ...
            fixed="right"
            width="90"
            v-if="permission('SeleMallGoods_edit') || permission('SeleMallGoods_dele')"
          >
            <template slot-scope="{ row }">
              <div class="grid-handle-list">
                ...
                >更改价格</el-button> -->
                <el-button
                  v-if="permission('SeleMallGoods_edit')"
                ...
                <el-button
                  v-if="permission('SeleMallGoods_dele')"
...
export default {
  ...
  methods: {
    ...
    handleEdit(row) {
      this.$router.push(`/sele-mall/goods-list/page/edit/${row.id}`)
    },
    handleAdd() {
      this.$router.push('/sele-mall/goods-list/page/add')
    },
    handleReset() {
