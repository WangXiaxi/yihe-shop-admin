<template>
  <span class="u-countdown">
    <span class="u-countdown-item" :style="[itemStyle]" v-if="showDays && (hideZeroDay || (!hideZeroDay && d != '00'))">
      <span class="u-countdown-time" :style="[letterStyle]">
        {{ d }}
      </span>
    </span>
    <span
    ...
    <span class="u-countdown-item" :style="[itemStyle]" v-if="showHours">
      <span class="u-countdown-time" :style="{ fontSize: fontSize + 'rpx', color: color}">
        {{ h }}
      </span>
    </span>
    <span
    ...
    <span class="u-countdown-item" :style="[itemStyle]" v-if="showMinutes">
      <span class="u-countdown-time" :style="{ fontSize: fontSize + 'rpx', color: color}">
        {{ i }}
      </span>
    </span>
    <span
      class="u-countdown-colon"
      :style="{fontSize: separatorSize + 'rpx', color: separatorColor, paddingBottom: separator == 'colon' ? '4rpx' : 0}"
      v-if="showMinutes && !(separator == 'colon' && !showSeconds) "
    >
      {{ separator == 'colon' ? (showSeconds ? ':' : '') : '分' }}
    </span>
    <span class="u-countdown-item" :style="[itemStyle]" v-if="showSeconds">
      <span class="u-countdown-time" :style="{ fontSize: fontSize + 'rpx', color: color}">
        {{ s }}
      </span>
    </span>
